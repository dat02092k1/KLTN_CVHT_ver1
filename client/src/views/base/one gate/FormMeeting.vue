<template>
  ...
  export default defineComponent({
    setup() {
      ...
      const pageTitle = ("Biên bản họp lớp");
    ...
    const sampleFile = "https://res.cloudinary.com/dpnjutbws/raw/upload/v1679735482/File_docs_CVHT_UET/j60p4iful6crughsrlbi.pdf";
